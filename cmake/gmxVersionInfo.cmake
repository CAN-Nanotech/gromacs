...
set(REGRESSIONTEST_MD5SUM "32b4260d285a3b6cf4ed1a922f74a21b" CACHE INTERNAL "MD5 sum of the regressiontests tarball for this GROMACS version")
...
set(GMX_VERSION_STRING_OF_FORK "keating" CACHE INTERNAL
...
if (GMX_VERSION_STRING_OF_FORK)
    ...
    set(GMX_MANUAL_DOI_INTERNAL "10.5281/zenodo.15387070") # Set correct doi string here
    set(GMX_SOURCE_DOI_INTERNAL "10.5281/zenodo.15387018") # Set correct doi string here
endif()
